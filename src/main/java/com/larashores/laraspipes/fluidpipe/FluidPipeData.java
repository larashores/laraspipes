...
/**
 * Datagen for the {@link FluidPipeBlock}.
 */
public class FluidPipeData extends PipeComponentData {
    /**
     * Creates the datagen class.
     */
    public FluidPipeData() {
        super(Registration.FLUID_PIPE_BLOCK);
    }

    /**
     * Registers the block states for the {@link FluidPipeBlock}. The method itself only implements the block states for
    ...
    /**
     * Registers the language data for the {@link FluidPipeBlock}.
     *
    ...
    public void register(LanguageProvider provider, String locale) {
        if (locale.equals("en_us")) {
            provider.add(REGISTERED_BLOCK.get(), "Fluid Pipe");
        }
    }

    /**
     * Registers recipes for the {@link FluidPipeBlock}.
     *
